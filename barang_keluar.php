                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($data_barang_keluar as $item): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?php echo $item['idkeluar']; ?>">
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $item['idkeluar']; ?>">
                                                        Hapus
                                                    </button>
                                                </td>
                                            </tr>
